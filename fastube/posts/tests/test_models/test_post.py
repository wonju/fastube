...
class PostModelTestCase(TestCase):
    ...
    def setUp(self):
        ...
        self.post = self.user.post_set.create(
            video_id=self.post_video_id,  # FIXME: should create using random create video_id
            title="test_title",
        )
    ...
    def test_post_model_should_have_youtube_original_url(self):
        ...
        """
        youtube_origina_url = "https://www.youtube.com/watch?v={video_id}".format(
            post_video_id=post_self.video_id,
        )
